...
app_log_file_handler = RotatingFileHandler(app_log_file, mode='a', maxBytes=1*1024*1024, backupCount=4, encoding='utf-8', delay=0)
...
weather_log_file_handler = RotatingFileHandler(weather_log_file, mode='a', maxBytes=1*1024*1024, backupCount=4, encoding=None, delay=0)
...
tcp_log_file_handler = RotatingFileHandler(tcp_log_file, mode='a', maxBytes=1*1024*1024, backupCount=4, encoding=None, delay=0)
...
iot_sdk_handler = RotatingFileHandler(iot_sdk_log_file, mode='a', maxBytes=1*1024*1024, backupCount=4, encoding=None, delay=0)
